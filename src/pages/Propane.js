    ...
    render() {
        return (
            <div className="container">
                <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>Propane Submission</span></h1><br />
                <form>
            ...
            <label for="employeename">Employee Name</label><br />
                ...
                <br /><br />
                <label for="tanksLeft">How many tanks are left in the cage:</label><br />
                <input type="number" id="tanksLeft" name="tanksLeft"/>
                <br /><br />
                <label for="picture">Take Picture:</label><br />
                <input type="file" name="picture" id="uploadPicture"></input><br /><br />
                <label >Notes:</label> <br />
                <textarea id="propaneNotes"></textarea>
                <br /><br />
