        ...
        render() {
            return (
                ...
                <label for="city">City:</label><br />
                    ...
                    <br /><br />
                    <label for="workType">Type of Work:</label><br />
                    <select>
                    ...
                    <br /><br />
                    <label for="equipment">What equipment needs to be moved:</label><br />
                    <textarea id="notes"></textarea>
                    <br /><br />
                    <label for="currentLocation">Curent location:</label><br />
                    <input type="text" id="currentLocation" name="currentLocation"/><br /><br />
                    <label >Supply Order Submitted:</label><br />
                    <label for="orderSubmitted">Yes</label>
                    <input type="radio" name="orderSubmitted" value="yes"></input>&nbsp;
                    <label for="orderSubmitted">No</label>
                    <input type="radio" name="orderSubmitted" value="no"></input>&nbsp;
                    <br /><br />
                    <label>Supply Order Date:</label><br />
                    <input type="date" id="orderDate"></input>
                    <br /><br />
                    <label for="orderNumber">Supply Order Number:</label><br />
