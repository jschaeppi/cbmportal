...
export class Repair extends Component {
    ...
    notListed = () => {
        if (this.state.notListed === true) {
            return (
                <div >
                    <label for="brandNotListed">Enter your machines brand:</label>
                    <input style={{width: "75%"}} type="text" className="newBrand" name="brandNotListed" id="newModel"></input>
                    <br />
                    <label for="brandNotListed">Enter Tag #:</label><br />
                    <input style={{width: "75%"}} type="number" className="newBrand" name="brandNotListed" id="machineTag"></input>
                </div>
            );
        }
    }
    render() {
        return (
            <div className="container">
                <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>Repair Submission</span></h1><br />
                <form>
            ...
            <div id="machineRow">
            <div id="machines">
                <input type="radio" name="machineType" value="Floor Scrubber" id="Machine Type0"></input>
                    <label for="Machine Type0"> Floor Scrubber</label>
                    <br />
                <input type="radio" name="machineType" value="Floor Buffer" id="Machine Type1"></input>
                    <label for="Machine Type1"> Floor Buffer</label>
            </div>
            
            <div id="machines">
                <input type="radio" name="machineType" value="Extractor" id="Machine Type3"></input>
                    <label for="Machine Type3"> Extractor</label>
                    <br />
                <input type="radio" name="machineType" value="Electric Buffer" id="Machine Type4"></input>
                    <label for="Machine Type4"> Electric Buffer</label>
            </div>
            <div id="machines">
                <input type="radio" name="machineType" value="Wet Vac" id="Machine Type5"></input>
                    <label for="Machine Type5"> Wet Vac</label>
                    <br />
                <input type="radio" name="machineType" value="Barracuda" id="Machine Type6"></input>
                    <label for="Machine Type6"> Barracuda</label>
            </div>
            </div>
            <br />
            ...
            <div id="brands">
            <div id="brand">
                <input type="radio" name="brandName" value="Noble" id="Brand 0" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 0"> Noble</label>
                    <br />
                <input type="radio" name="brandName" value="Tennant" id="Brand 1" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 1"> Tennant</label>
                    <br />
                <input type="radio" name="brandName" value="RST-34" id="Brand 2" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 2"> RST-34</label>
                    <br />
                <input type="radio" name="brandName" value="Viper" id="Brand 3" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 3"> Viper</label>
            </div>
            
            <div id="brand">
                <input type="radio" name="brandName" value="Advance Aqua Clean 18 FLX" id="Brand 4" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 4"> Advance Aqua Clean 18 FLX</label>
                    <br />
                <input type="radio" name="brandName" value="Clarke" id="Brand 5" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 5"> Clarke</label>
                    <br />
                <input type="radio" name="brandName" value="Clarke Focus I" id="Brand 6" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 6"> Clarke Focus I</label>
                    <br />
                <input type="radio" name="brandName" value="Clarke Focus II" id="Brand 7" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 7"> Clarke Focus II</label>
            </div>
            <div id="brand">
                <input type="radio" name="brandName" value="Eagle" id="Brand 8" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 8"> Eagle</label>
                    <br />
                <input type="radio" name="brandName" value="Pioneer" id="Brand 9" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 9"> Pioneer</label>
                    <br />
                <input type="radio" name="brandName" value="Taski" id="Brand 10" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 10"> Taski</label>
                    <br />
                <input type="radio" name="brandName" value="Not Listed" id="Brand 11" onClick={this.handleChange.bind(this)}></input>
                    <label for="Brand 11"> Not Listed</label>
                    <br />
                    {this.notListed()}
            </div>
            </div>
                ...
                <textarea type="text" name="problem" id="problemDescription"></textarea>
                    <br /><br />
                    <label for="picture">Take Picture:</label><br />
                <input type="file" name="picture" id="uploadPicture"></input>
                </div>
                <br /><br />
                <div id="reportedDiv">
                <label for="reported">Reported By:</label><br />
                <input type="text" name="reported" id="reportedBy"></input>
                </div><br /><br />
