    ...
    const getStoreList = () => {
        ...
        return (
            ...
            { mileage.map((row, index) => { 
                        ...
                        return (
                            <div key={index}>
                                <label for={mileageDate}>{mileageDate}</label><br />
                                <input key={mileageDate} type="date" id={mileageDate}  onChange={e => handleInputChange(e, index)} ></input><br /><br />
                                <label for={startingPoint}>{startingPoint}</label><br />
                                <select key={startingPoint} id={startingPoint} onChange={e => handleInputChange(e, index)}>{getStoreList()}</select><br /><br />
                                <label for={destinationPoint}>{destinationPoint}</label><br />
                                <select key={destinationPoint} id={destinationPoint} onChange={e => handleInputChange(e, index)}>{getStoreList()}</select><br /><br />
