...
class NewHire extends React.Component {
    ...
    getStoreList = () => {
        return (
            <select name="stores" id="storeList">
    ...
    render() {
        return (
            ...
            <h1 className="heading"><span>New Hire Form </span></h1><br />
                <form id="newHireForm">
                    <div className="wrapper1" id="radio">
                        <label for="newhire" className="hiretype">New Hire:</label>
                        <input type="radio" className="radiohire" name="hiretype" id="newhire" value="newhire"/>
                    </div>
                    <div className="wrapper1" id="radio">
                        <label for="rehire" className="hiretype">Rehire:</label>
                        <input type="radio" className="radiohire" name="hiretype" id="rehire" value="rehire"/> <br />
                    </div>
                    <br />
                    ...
                    <div className="wrapper1">
                        ...
                        <textarea name="address" id="address"></textarea> <input type="email" id="email" name="email"/>
                    </div>
                    <br /><br />
                    <div className="wrapper1">
                        <label for="phone">Phone: </label><label for="phone2">Alt phone:</label>
                        <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" title="Enter in format ###-###-####"/>
                        <input type="tel" id="phone2" name="phone2" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" title="Enter in format ###-###-####"/> 
                    </div>
                    <br />
                    <   label for="ssn">SSN:</label>
                    <br />
                        <input type={(this.state.isHidden) ? "password":"text"} id="ssn" name="ssn" pattern="[0-9]{3}-[0-9]{2}-[0-9]{4}" title="Enter in format ###-##-####" />
                        <i className="far fa-eye" onClick={this.ssnHide.bind(this)}></i>
                    <br /><br />
                    <div className="wrapper1">
                        <label for="dob">DOB:</label>
                        <label for="sex">Gender</label>
                        <input type="date" id="dob" name="dob" className="dob" />
                    ...
                    <br /><br />
                    <div className="wrapper1">
                        <label for="firstday">First Day Worked:</label>
                        <label for="numDays"># Work Days</label><br />
                        <input type="date" id="firstday" name="firstday" className="firstday" />
                    ...
                    <br /><br />
                    <div className="wrapper1">
                        <label for="wage">Pay rate /hr:</label>
                    ...
                    <br />
                    <div className="wrapper1" id="prefLangauge">
                    <br /><label >Preferred Language</label>
                    </div>
                    <div className="wrapper1" id="hours">
                        <label for="30more" id="hoursLabel">More than 30hrs</label>
                        <input type="radio" className="daysWorked" name="hours" id="30more" value="More than 30 hours"/>
                        &nbsp;
                        <label for="english" >English</label>
                        <input type="radio" className="radiohire" name="language" id="english" value="English"/>
                        
                    </div>
                    <div className="wrapper1" id="hours">
                        <label for="30less" id="hoursLabel">Less than 30hrs</label>
                        <input type="radio" className="daysWorked" name="hours" id="30less" value="Under 30 hours"/> 
                        &nbsp;
                        <label for="spanish" >Spanish</label> 
                        <input type="radio" className="radiohire" name="language" id="spanish" value="Spanish"/>
                        
                    </div>
                    <br /><br />
                    <div className="wrapper1">
                    <label for="i91">Take Picture of section 1 of I9</label>
                    <input type="file" id="i91" name="i91" />
                    </div>
                    <br /><br />
                    <div className="wrapper1">
                    <label for="numdays">Take Picture of section 2 of I9</label>
                    <input type="file" id="i92" name="i92" />
                    </div>
                    <br /><br />
                    <div className="wrapper1">
                    <label for="idbadge">Upload a picture for ID Badge</label>
                    <input type="file" id="idbadge" name="idbadge" />
                    </div>
                    <br /><br />
