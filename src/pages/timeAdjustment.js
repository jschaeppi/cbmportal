...
import EmployeePad from '../Components/employeeSig'
    ...
    const handleRemoveRow = (e, index) => {
        ...
        return (
            <div className="container">
                <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>Time Adjustment</span></h1><br />
                <form>
            ...
            { adjustment.map((row, index) => { 
                        ...
                        const adjustmentName = `Adjustment ${incIndex}`;
                        ...
                        return (
                            <div key={index}>
                                ...
                                <label for={breakhName}>{breakhName}</label><br />
                                <input key={breakhName} type="datetime-local" id={breakhName} name={breakhName} onChange={e =>handleInputChange(e, index)}></input><br />
                                <label for={adjustmentName}>{adjustmentName}</label><br />
                                <input key={adjustmentName} type="datetime-local" id={adjustmentName} name={adjustmentName} onChange={e => handleInputChange(e, index)}></input><br />
                                ...
                                {adjustment.length !== 1 && <button onClick={e => handleRemoveRow(e,index)} id="backPayRemoveButton">Remove</button>}
                                {adjustment.length - 1 === index && <button onClick={handleTimeAdjustment} id="backPayAddButton">Add Back Pay</button>}
                            </div>
                        );
                    })}
                    <br /><br />
                <label >Reason why this pay was missed:</label> <br />
                <textarea id="noteAdjustment"></textarea>
                <br /><br />
