        ...
        return (
            <div className="container">
                ...
                <div>
                    ...
                    <input type="radio" name="twoWeeks" id="twoWeeks" value="yes" required title="Please enter the required information" onChange={this.handleChange}/>
                    &nbsp;|&nbsp;
                    <label htmlFor="twoWeeks" >No</label>&nbsp;
                    <input type="radio" name="twoWeeks" id="twoWeeks" value="no" required title="Please enter the required information" onChange={this.handleChange}/>
                    </div>
                    <div id="discipline">
