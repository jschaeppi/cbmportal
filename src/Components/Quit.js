        ...
        return (
            <div className="container">
                ...
                <form>
                    ...
                    <label >Was two weeks given:</label><br />
                    <label for="yes_notice" >Yes</label>&nbsp;
                    <input type="radio" name="twoweeks" id="yes_notice" value="yes"/>
                    &nbsp;|&nbsp;
                    <label for="no_notice" >No</label>&nbsp;
                    <input type="radio" name="twoweeks" id="no_notice" value="no"/> <br /><br />
