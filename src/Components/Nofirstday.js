...
export class Nofirstday extends Component {
    ...
    onSubmit = (e) => {
        e.preventDefault();
            fetch('http://portal.cbmportal.com:5000/api/nsfd/', {
            method: 'POST',
            headers: {
        ...
        return (
            <div className="container">
                ...
                <div>
                    ...
                    <div>
                    <label htmlFor="norehirereason" style={{visibility: this.state.isHidden ? "hidden":"visible"}}>Explain why to not rehire employee:</label>
