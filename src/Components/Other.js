    ...
    render() {
        return (
            <div className="container">
                <h1 className="heading">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>Other</span></h1><br />
                <form>
                    ...
                    <label >Any prior verbal discussions/warnings given:</label><br />
                    <label for="yes_warning" >Yes</label>&nbsp;
                    <input type="radio" name="warnings" id="yes_warning" value="yes"/>
                    &nbsp;|&nbsp;
                    <label for="no_warning" >No</label>&nbsp;
                    <input type="radio" name="warnings" id="no_warning" value="no"/> <br /><br />
                    ...
                    <label for="norehirereason" style={{visibility: this.state.isHidden ? "hidden":"visible"}}>Employee reason for quitting:</label> <br />
